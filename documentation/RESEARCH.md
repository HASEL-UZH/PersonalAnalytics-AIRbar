...
| Parameter                      | Description                                                                                                                                                                                                                                   | Change Required | Default Value |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|---------------|
| `enabled`                      | Master toggle for TaskSnap and AIRbar functionality. When disabled, neither feature is initialized or shown.                                                                                                                              |                 | `true`        |
...
| `enabledTaskbar`               | Whether the study permits participants to use the always-on AIRbar tasks view.                                                                                                                                                             |                 | `true`        |
