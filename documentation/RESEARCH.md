...
#### TaskTracker (TaskSnap and AIRbar)
| Parameter                      | Description                                                                                                                                                                                                                                   | Change Required | Default Value |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|---------------|
| `enabled`                      | Master toggle for TaskSnap and the legacy AIRbar functionality. When disabled, neither feature is initialized or shown.                                                                                                                       |                 | `true`        |
| `taskContextCapturingEnabled`  | Whether TaskSnap may capture and restore task contexts. When disabled, the task tracker retains the existing AIRbar functionality without ContextSnap features.                                                                                |                 | `true`        |
| `enabledTaskbar`               | Whether the study permits participants to use the always-on AIRbar taskbar. This legacy setting remains available while TaskSnap's taskbar and overlay behavior is being finalized.                                                           |                 | `true`        |
| `enabledRetrospection`         | Whether the study permits participants to use the AIRbar retrospection functionality.                                                                                                                                                         |                 | `true`        |
| `defaultExcludedApps`          | Application identifiers that TaskSnap excludes from ContextSnaps by default. Excluded applications must not be closed as part of a snapshot operation.                                                                                        |                 | `[]`          |
| `defaultExcludedWebsites`      | Website hostnames that TaskSnap excludes from ContextSnaps by default, for example `calendar.example.org`. Excluded websites must not be closed as part of a snapshot operation.                                                              |                 | `[]`          |
